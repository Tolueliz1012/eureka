...
export default function Dashboard({ userId, userName, onStartLearning, onNewSubject, onLogout }) {
  ...
  const styles = {
    ...
    nav: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 40px", borderBottom: "1px solid rgba(255,255,255,0.06)" },
    ...
    body: { maxWidth: 960, margin: "0 auto", padding: "48px 40px" },
    h1: { fontSize: 42, fontWeight: 400, lineHeight: 1.1, color: "#F5F3EE", marginBottom: 8, fontFamily: "Georgia, serif" },
    subtitle: { color: "#6B6875", fontSize: 16, fontWeight: 300, fontFamily: "system-ui, sans-serif", marginBottom: 48 },
    statsGrid: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16, marginBottom: 48 },
    statCard: { background: "#18181F", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: 24 },
    statVal: { fontSize: 40, fontWeight: 600, color: "#F5F3EE", lineHeight: 1, marginBottom: 6, fontFamily: "system-ui, sans-serif" },
    statLabel: { fontSize: 13, color: "#6B6875", textTransform: "uppercase", letterSpacing: "0.08em", fontFamily: "system-ui, sans-serif" },
